...
@push('css')
    ...
    <style>
        .header-bg{
            height: 400px;
            width: 100%;
            background-image: {{ asset('/uploads/img/post') }}/{{ $post->image }};
                ...
                <div class="col-lg-8 col-md-12 no-right-padding">
                    <div class="main-post">
                        <div class="blog-post-inner">
                            <div class="post-info">
                                <div class="left-area">
                                    <a class="avatar" href="#"><img src="{{ asset('/uploads/img/profile') }}/{{ $post->user->image }}" alt="Profile Image"></a>
                                </div>
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12">
                    <div class="comment-form">
                        @guest
                            <p>Комментарии могу оставлять только зарегистрированные пользователи<a href="{{ route('login') }}">Login</a></p>
                        @else
                            <form method="post" action="{{ route('comment.store',$post->id) }}">
                                @csrf
                                <div class="row">
                                    <div class="col-sm-12">
                                        <textarea aria-label="" name="comment" rows="2" class="text-area-messge form-control" placeholder="Enter your comment" aria-required="true" aria-invalid="false"></textarea >
                                    </div>
                                    <div class="col-sm-12">
